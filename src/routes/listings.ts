  ...
  app.post('/listings', async (request, reply) => {
    ...
    const listing = await prisma.listing.create({
      data: {
        ...
        tramerAmount: payload.tramerAmount,
        severeDamage: payload.severeDamage,
        paintedParts: payload.paintedParts,
        changedParts: payload.changedParts,
        mechanicalStatus: payload.mechanicalStatus,
        maintenanceHistory: payload.maintenanceHistory,
        appraisalReport: payload.appraisalReport,
        damageParts: payload.damageParts,
